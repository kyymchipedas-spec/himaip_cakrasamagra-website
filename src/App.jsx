...
export default function App() {
  ...
  function tryLogin() {
    if (codeInput === ADMIN_CODE) { setIsAdmin(true); setShowLogin(false); setCodeInput(""); setLoginError(""); }
    ...
    <div style={S.page}>
      <header style={S.header}>
        <div style={S.headerLeft}>
          ...
          <button style={S.adminBtnHeader} onClick={() => isAdmin ? setIsAdmin(false) : setShowLogin(true)}>
...
const S = {
  ...
  modalBox:{background:"#FAF7F2",borderRadius:8,padding:30,maxWidth:360,width:"100%",textAlign:"center"},
